...
The script [extract-osx-sdk.sh](https://github.com/voltpotcoin-project/voltpotcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
voltpotcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/voltpotcoin-project/voltpotcoin/blob/master/doc/README_osx.md) for troubleshooting tips.