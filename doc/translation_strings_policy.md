...
This document provides guidelines for internationalization of the VoltPotCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `voltpotcoin_en.ts` remains unchanged.
