Contributing to VoltPotCoin Core
================================

The VoltPotCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/voltpotcoin-project/voltpotcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the VoltPotCoin Core project, and is not to be
confused with overall VoltPotCoin Network Protocol consensus changes.

Whether a pull request is merged into VoltPotCoin Core rests with the project merge
...
Patches that change VoltPotCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the VoltPotCoin consensus, it must have been
...
The project leader is the release manager for each VoltPotCoin Core release.
