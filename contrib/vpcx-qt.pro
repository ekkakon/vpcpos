...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/voltpotcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/voltpotcoin-cli.cpp \
           src/voltpotcoin-tx.cpp \
           src/voltpotcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/voltpotcoin.qrc src/qt/voltpotcoin_locale.qrc

TRANSLATIONS += src/qt/locale/voltpotcoin_bg.ts \
                src/qt/locale/voltpotcoin_de.ts \
                src/qt/locale/voltpotcoin_en.ts \
                src/qt/locale/voltpotcoin_es.ts \
                src/qt/locale/voltpotcoin_fi.ts \
                src/qt/locale/voltpotcoin_fr.ts \
                src/qt/locale/voltpotcoin_it.ts \
                src/qt/locale/voltpotcoin_ja.ts \
                src/qt/locale/voltpotcoin_pl.ts \
                src/qt/locale/voltpotcoin_pt.ts \
                src/qt/locale/voltpotcoin_ru.ts \
                src/qt/locale/voltpotcoin_sk.ts \
                src/qt/locale/voltpotcoin_sv.ts \
                src/qt/locale/voltpotcoin_vi.ts \
                src/qt/locale/voltpotcoin_zh_CN.ts \
                src/qt/locale/voltpotcoin_zh_TW.ts
