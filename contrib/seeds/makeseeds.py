...
def main():
    ...
    # Filter out hosts with multiple voltpotcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple voltpotcoin ports' % (ip_stats(ips)), file=sys.stderr)
