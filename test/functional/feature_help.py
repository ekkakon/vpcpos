...
"""Verify that starting voltpotcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import VoltpotcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(VoltpotcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start voltpotcoin with -h for help text")
        ...
        self.log.info("Start voltpotcoin with -version for version information")
