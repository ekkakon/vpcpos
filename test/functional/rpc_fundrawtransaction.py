...
class RawTransactionsTest(VoltpotcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid voltpotcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid voltpotcoin address" in e.error['message'])
