/* src/config/voltpotcoin-config.h.  Generated from voltpotcoin-config.h.in by configure.  */
/* src/config/voltpotcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.voltpotcoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VoltPotCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VoltPotCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "voltpotcoin"
