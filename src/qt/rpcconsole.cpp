                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzVPCPathCustom = GetArg("-zvpcbackuppath", "");
    ...
    if(!strzVPCPathCustom.empty()) {
        ui->wallet_customzvpcbackuppath->setText(QString::fromStdString(strzVPCPathCustom));
        ui->wallet_customzvpcbackuppath_label->setVisible(true);
        ui->wallet_customzvpcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzVPCPathCustom.empty()) && nCustomBackupThreshold > 0) {
