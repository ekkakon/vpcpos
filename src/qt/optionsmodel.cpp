...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset){
    ...
    if (settings.contains("nAnonymizeVoltpotcoinAmount") || reset)
        SoftSetArg("-anonymizevoltpotcoinamount", settings.value("nAnonymizeVoltpotcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in voltpotcoin.cpp during shotdown to also remove the window positions
