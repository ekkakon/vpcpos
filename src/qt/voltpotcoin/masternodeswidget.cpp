...
#include "qt/voltpotcoin/forms/ui_masternodeswidget.h"

#include "qt/voltpotcoin/qtutils.h"
#include "qt/voltpotcoin/mnrow.h"
#include "qt/voltpotcoin/mninfodialog.h"
#include "qt/voltpotcoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(VoltPotCoinGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:37572 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 20000)) {
        inform(tr("Not enough balance to create a masternode, 20,000 VPC required."));
        return;
    }
    showHideOp(true);
