...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, VoltPotCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, VoltPotCoinGUI* gui, double posX = 3);
