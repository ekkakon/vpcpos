...
#include "qt/voltpotcoin/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 37572");
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("47572");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("57572");
    } else {
        ui->lineEditPort->setText("37572");
    }
