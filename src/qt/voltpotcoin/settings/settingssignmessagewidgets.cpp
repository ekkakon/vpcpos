...
#include "qt/voltpotcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(VoltPotCoinGUI* _window, QWidget *parent) :
