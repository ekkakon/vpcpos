...
#include "qt/voltpotcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/voltpotcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(VoltPotCoinGUI* _window, QWidget *parent) :
