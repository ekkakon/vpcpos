...
#include "qt/voltpotcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(VoltPotCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("VoltPotCoin_tx_csv_export(*.csv)") : tr("VoltPotCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
