...
#include "qt/voltpotcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/voltpotcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(VoltPotCoinGUI* _window, QWidget *parent) :
