...
#include "qt/voltpotcoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/voltpotcoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(VoltPotCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    // Web Link
    ui->pushButtonWebLink->setText("https://VoltPotCoin.org/");
    ...
    if (parent)
        connect(parent, &VoltPotCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
