...
#include "qt/voltpotcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/voltpotcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(VoltPotCoinGUI* _window, QWidget *parent) :
