...
#include "qt/voltpotcoin/settings/settingsnetworkwidget.h"
#include "qt/voltpotcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/voltpotcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(VoltPotCoinGUI* _window, QWidget *parent) :
