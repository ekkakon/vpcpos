...
#include "qt/voltpotcoin/contactsdropdown.h"
#include "qt/voltpotcoin/sendmultirow.h"
#include "qt/voltpotcoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(VoltPotCoinGUI* parent);
    ~SendWidget();
...
private Q_SLOTS:
    void onVPCSelected(bool _isVPC);
    void onSendClicked();
...
private:
    ...
    bool sendZvpc(QList<SendCoinsRecipient> recipients);
