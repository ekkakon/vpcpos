...
#include "qt/voltpotcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(VoltPotCoinGUI* parent, WalletModel* model) :
    QDialog(parent),
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &VoltPotCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
