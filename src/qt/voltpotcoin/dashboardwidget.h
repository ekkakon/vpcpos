...
#include "config/voltpotcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalVpc = 0;
    qint64 totalZvpc = 0;
    QList<qreal> valuesVpc;
    QList<qreal> valueszVpc;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(VoltPotCoinGUI* _window);
    ~DashboardWidget();
