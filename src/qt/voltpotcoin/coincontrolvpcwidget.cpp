    ...
    ui(new Ui::CoinControlVpcWidget)
{
    ...
    ui->labelTitle->setText("Select VPC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("VPC");
    ...
    ui->labelValueAfter->setText("0.00 VPC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 VPC");
    ui->labelValueFee->setText("0.00 VPC");
