...
#ifndef VoltPotCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define VoltPotCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //VoltPotCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
