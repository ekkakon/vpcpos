...
#include "qt/voltpotcoin/forms/ui_receivewidget.h"
...
#include "qt/voltpotcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(VoltPotCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive VPC."));
