...
#include "qt/voltpotcoin/forms/ui_coldstakingwidget.h"
#include "qt/voltpotcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/voltpotcoin/requestdialog.h"
#include "qt/voltpotcoin/tooltipmenu.h"
#include "qt/voltpotcoin/furlistrow.h"
...
#include "qt/voltpotcoin/csrow.h"
...
ColdStakingWidget::ColdStakingWidget(VoltPotCoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your VPCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept VPC delegation / Delegate VPC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select VPC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 VPC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
