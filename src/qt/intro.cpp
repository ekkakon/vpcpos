...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("VoltPotCoin Core"),
     ...
     * override -datadir in the voltpotcoin.conf file in the default data directory
     * (to be consistent with voltpotcoind behavior)
     */
