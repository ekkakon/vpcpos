...
/** Utility functions used by the VoltPotCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render VoltPotCoin addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZvpc = false);
...
// Parse "voltpotcoin:" URI into recipient object, return true on successful parsing
