...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and voltpotcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVPC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VoltPotCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about VoltPotCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a VoltPotCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VoltPotCoin Core help message to get a list with possible VoltPotCoin command-line options"));
