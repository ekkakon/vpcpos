...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case VPC:
        return QString("voltpotcoin");
    case mVPC:
        return QString("mvoltpotcoin");
    case uVPC:
        return QString::fromUtf8("uvoltpotcoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZvpc)
{
    QString z = "";
    if(isZvpc) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case VPC:
            return z + QString("VPC");
        case mVPC:
            return z + QString("mVPC");
        case uVPC:
            return z + QString::fromUtf8("μVPC");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VPC:
            return z + QString("tVPC");
        case mVPC:
            return z + QString("mtVPC");
        case uVPC:
            return z + QString::fromUtf8("μtVPC");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVPC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZVPC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZVPC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZVPC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
