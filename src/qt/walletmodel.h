...
#ifndef VoltPotCoin_QT_WALLETMODEL_H
#define VoltPotCoin_QT_WALLETMODEL_H
...
/** Interface to VoltPotCoin wallet from Qt view code. */
...
#endif // VoltPotCoin_QT_WALLETMODEL_H
