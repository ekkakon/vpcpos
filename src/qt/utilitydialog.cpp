...
#include "qt/voltpotcoin/qtutils.cpp"
                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("VoltPotCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About VoltPotCoin Core"));
        ...
        licenseInfoHTML.replace(uri, "<a style='color: #8affb1;text-decoration:none'  href=\"\\1\">\\1</a>");
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("VoltPotCoin Core is shutting down...") + "<br /><br />" +
