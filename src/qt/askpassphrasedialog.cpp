                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zVPC || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending VPC because you wouldn't check it anyway.
    if (context == Context::Send_VPC || context == Context::Send_zVPC) {
