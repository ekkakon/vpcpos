...
/**
 * VoltPotCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZvpcSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzvpcseed(const UniValue& params, bool fHelp);
extern UniValue getzvpcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzvpc(const UniValue& params, bool fHelp);
extern UniValue dzvpcstate(const UniValue& params, bool fHelp);
