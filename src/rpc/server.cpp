...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VoltPotCoin features */
        {"voltpotcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"voltpotcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"voltpotcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"voltpotcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"voltpotcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"voltpotcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"voltpotcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"voltpotcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"voltpotcoin", "startmasternode", &startmasternode, true, true, false},
        {"voltpotcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"voltpotcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"voltpotcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"voltpotcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"voltpotcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"voltpotcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"voltpotcoin", "preparebudget", &preparebudget, true, true, false},
        {"voltpotcoin", "submitbudget", &submitbudget, true, true, false},
        {"voltpotcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"voltpotcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"voltpotcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"voltpotcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"voltpotcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"voltpotcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"voltpotcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"voltpotcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"voltpotcoin", "mnsync", &mnsync, true, true, false},
        {"voltpotcoin", "spork", &spork, true, true, false},
        {"voltpotcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzvpcseed", &getzvpcseed, false, false, true},
        {"zerocoin", "setzvpcseed", &setzvpcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzvpc", &searchdzvpc, false, false, true},
        {"zerocoin", "dzvpcstate", &dzvpcstate, false, false, true},
...
{
    return "> voltpotcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37571/\n";
}
