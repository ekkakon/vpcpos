...
#ifndef VoltPotCoin_ZVPCWALLET_H
#define VoltPotCoin_ZVPCWALLET_H
...
public:
    ...
    void GenerateDeterministicZVPC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZVPC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //VoltPotCoin_ZVPCWALLET_H
