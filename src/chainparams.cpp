...
public:
    CMainParams()
    {
        ...
        consensus.height_start_StakeModifierNewSelection = 1002;
        ...
        // validation by-pass
        consensus.nVoltpotcoinBadBlockTime = 1625302057;    // Skip nBit validation of Block 1001 per PR #915
        consensus.nVoltpotcoinBadBlockBits = 0x1e00b841;    // Skip nBit validation of Block 1001 per PR #915
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nVoltpotcoinBadBlockTime = 1625302044; // Skip nBit validation of Block 201 per PR #915
        consensus.nVoltpotcoinBadBlockBits = 0x1d065bba; // Skip nBit validation of Block 201 per PR #915
