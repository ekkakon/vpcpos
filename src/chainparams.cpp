...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nVoltpotcoinBadBlockTime = 1625302057; // Skip nBit validation of Block 201 per PR #915
        consensus.nVoltpotcoinBadBlockBits = 0x1e00b841; // Skip nBit validation of Block 201 per PR #915
